...
<body>
    ...
    <div class="main-content">
        <header>
            <div class="header-titles">
                <h2>
                    <a href="stok-makanan-link">Stok Bahan Makanan </a> > Ubah Stok Bahan Makanan
                </h2>
            </div>                  
        ...
        <div class="dashboard-container"></div>
            <form action="/editstokbahanmakananpost/{{ $makanan->id }}" method="POST" enctype="multipart/form-data" class="food-form">
                @csrf
                ...
                <div class="form-group">
                    <label for="foodName">Nama Bahan</label>
                    <input type="text" id="foodName" name="nama" placeholder="Masukkan Bahan Makanan" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="stock-container">
                        <input type="number" id="foodStock" name="stockmin" placeholder="3" required>
                        
                        <select id="foodStockUnit" name="satuanmin" required>
                        ...
                        <input type="number" id="foodStockMax" name="stockmax" placeholder="5" required>
                        
                        <select id="foodStockMaxUnit" name="satuanmax" required>
                            <option value="kg">kg</option>
                            <option value="gram">gram</option>
                            <option value="liter">liter</option>
                            <option value="ml">ml</option>
    ...
    <script>
        ...
        const foodData = {
            ...
            unit: "{{ $makanan->satuanmin }}",
            unitMax: "{{ $makanan->satuanmax }}",
        ...
        function preFillForm() {
            ...
            document.getElementById('foodStockUnit').value = foodData.unit;
            document.getElementById('foodStockMaxUnit').value = foodData.unitMax;
