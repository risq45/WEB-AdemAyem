    ...
    <div class="main-content">
        <header>
            <div class="header-titles">
                <h2>
                    <a href="stok-makanan-link">Stok Bahan Makanan </a>>Buat Stok Bahan Makanan
                </h2>
            </div>            
        ...
        <div class="dashboard-container"></div>
            <form action="/tambahstokbahanmakananpost" method="POST" enctype="multipart/form-data" class="food-form">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="foodName" name="nama" placeholder="Masukkan Nama Bahan" required>
                </div>
