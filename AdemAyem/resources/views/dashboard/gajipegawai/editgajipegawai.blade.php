...
<body>
    ...
    <div class="main-content">
        ...
        <div class="dashboard-container"></div>
            <form action="/editgajipegawaipost/{{ $gaji->id }}" method="POST" enctype="multipart/form-data" class="food-form">
                @csrf
    ...
    <script>
        ...
        function preFillForm() {
            ...
            document.getElementById('gajipokokPegawai').value = pegData.pokok;
            document.getElementById('tunjanganPegawai').value = pegData.tunjangan;
            document.getElementById('tanggalPembayaran').value = pegData.tanggal;
        }
