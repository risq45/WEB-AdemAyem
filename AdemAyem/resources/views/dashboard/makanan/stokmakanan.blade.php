    ...
    <div class="main-content">
        <header>
            ...
            <div class="header-buttons">
                ...
                <form action="/tambahstokmakanan" method="GET">
        ...
        <div class="dashboard-container"></div>
            <table class="default-table">
                ...
                <tbody>
                    @if($makanan->isEmpty())
                        <tr>
                            <td colspan="7" class="no-data">Tidak ada data makanan yang tersedia.</td>
                        </tr>
                    @endif
                    ...
                    <tr>
                        ...
                        @endif
                        <td>{{ $item->stockmin }} dari {{ $item->stockmax}} stok</td>
                        <td>{{ $item->kategori }}</td>
                        <td>
                            <div class="button-group">
                                <form action="/editstokmakanan/{{ $item->id }}" method="GET">
                                    <button class="btn btn-edit">Ubah</button>
                                </form>
                                
                                <form action="/hapusstokmakananpost/{{ $item->id }}" method="POST">
                                    @csrf
