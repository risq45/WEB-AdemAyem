    ...
    <div class="main-content">
        <header>
            <div class="header-titles">
                <h2>
                    <a href="stok-makanan-link">Stok Makanan </a>>Buat Stok Makanan
                </h2>
            </div>            
        ...
        <div class="dashboard-container"></div>
            <form action="/tambahstokmakananpost" method="POST" enctype="multipart/form-data" class="food-form">
                @csrf
                <!-- <div class="form-group image-upload">
                    <input type="file" id="foodImage" name="foodImage" accept="image/*" required style="display: none;" onclick="event.stopPropagation();">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="foodName" name="nama" placeholder="Masukkan Nama Makanan" required>
                </div>
                ...
                <div class="form-group button-container">
                    <form action="/stokmakanan" method="GET">
